...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  UNSUPPORTED_UI_FORMAT: "检测到 ComfyUI 普通工作流 JSON，请在 ComfyUI 中将该工作流导出为 API Format JSON，然后重新选择该文件。",
  INVALID_JSON: "无法读取这个文件，它不是有效的 JSON。",
  WORKFLOW_INVALID_JSON: "无法读取这个文件，它不是有效的 JSON。",
  UNKNOWN: "这个 JSON 不是可识别的 ComfyUI 工作流。",
  UNKNOWN_JSON: "这个 JSON 不是可识别的 ComfyUI 工作流。",
  ...
  ARTIFACT_NOT_FOUND: "找不到该生成产物，请刷新生产记录。",
  ARTIFACT_FILE_MISSING: "生成产物文件已不存在；可以重新生成或从备份恢复。",
  ARTIFACT_PATH_INVALID: "生成产物的位置不安全或无法访问，已阻止打开。",
  ARTIFACT_OPEN_FAILED: "操作系统无法打开该生成产物。",
  ARTIFACT_REVIEW_CONFLICT: "该产物审核状态已被更新，请刷新审核队列后重试。",
  ARTIFACT_REVIEW_INVALID: "该产物当前不能执行此审核操作。",
