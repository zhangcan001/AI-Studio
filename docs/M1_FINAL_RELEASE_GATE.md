...
升级前 `app.db` SHA-256：`203EADD24B78F15B164A1BB1AEA55EA253CCCA3DF7E9CB25FE1D7A78E503DB13`。
最终运行后的 `app.db` SHA-256：`CE282CAFEFB2E53AF4859CF254C7C60889095B89EE464EAB45E9AF44155A29A3`。
后一个指纹包含本轮真实任务、资产和正常启动/退出日志写入；因此以结构、记录和文件指纹核对数据保留，
不把合法运行时写入误判为覆盖。
