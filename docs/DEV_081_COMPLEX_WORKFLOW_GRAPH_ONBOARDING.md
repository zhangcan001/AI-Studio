...
## DEV-081 BUILTIN RECIPE UPGRADE CLOSEOUT — Agent-D test evidence

This audit is based on `106d8ad4d75d3ec9693c90f0abb6b1a5fb5470ad`. Agent-D only
changed the two DEV-081 test files and this document. No commit or push was
performed by Agent-D, and the user's real Desktop JSON or prompt was not read
or committed.

```text
RAW_SHA_DUPLICATE_MATCH_CONFIRMED=YES
BUILTIN_RECIPE_UPGRADE_CLOSEOUT=YES
SEMANTIC_WORKFLOW_IDENTITY=YES
RAW_WORKFLOW_SHA_PRESERVED=YES
SEMANTIC_WORKFLOW_FINGERPRINT=PASS
SEMANTIC_SCOPE_CANONICAL_JSON_ONLY=YES
GRAPH_ISOMORPHISM=NO

SEMANTIC_SAME_WHITESPACE=TESTED
SEMANTIC_SAME_KEY_ORDER=TESTED
SEMANTIC_SAME_PRETTY_COMPACT=TESTED
SEMANTIC_DIFFERENT_STEPS=TESTED
SEMANTIC_DIFFERENT_LINK=TESTED
SEMANTIC_DIFFERENT_MODEL=TESTED
SEMANTIC_DIFFERENT_NODE_ID=TESTED
BUILTIN_WORKFLOW_MATCHED_BY_SEMANTIC_IDENTITY=PASS
EXISTING_MATCH_TYPE=SEMANTIC_SHA
EXISTING_RECIPE_OUTDATED=PASS
REGENERATE_RECIPE=PASS

BUILTIN_WORKFLOW_IMMUTABLE=PASS
BUILTIN_OLD_RECIPE_IMMUTABLE=PASS
BUILTIN_NEW_RECIPE_VERSION=PASS
WORKFLOW_VERSION_UNCHANGED=PASS
BUILTIN_FLAG_PRESERVED=PASS
EXPLICIT_PROJECT_REBIND=EXISTING_DEV081_E2E_PASS
PROJECT_EXPLICIT_REBIND=PASS
PROJECT_VIDEO_DEFAULT_NEW_RECIPE=PASS

SANITIZED_T2V_PACKAGE=3_ITEMS
PACKAGE_BEFORE_UPGRADE_READY=0
PACKAGE_BEFORE_UPGRADE_BLOCKED=3
PACKAGE_BEFORE_UPGRADE_REASON=duration_seconds missing
PACKAGE_AFTER_UPGRADE=EXISTING_DEV059_E2E_PASS
PACKAGE_AFTER_UPGRADE_READY=3
PACKAGE_AFTER_UPGRADE_BLOCKED=0
PACKAGE_AFTER_UPGRADE_CREATE=3
CREATED_COUNT=3
AUTO_START_ON_CREATE=NO
BUILTIN_T2V_PACKAGE_AFTER_UPGRADE=PASS
DEV078_EXACT_NEW_RECIPE=EXISTING_DEV059_E2E_PASS
FAKE_COMFY_3_ITEMS=EXISTING_DEV059_E2E_PASS
DEV078_NEW_RECIPE_EXACT_ADMISSION=PASS
...
BACKUP_AFTER=16
NEW_DB_TABLE=NO
SEMANTIC_HASH_PERSISTED=NO
REAL_USER_WORKFLOW_COMMITTED=NO
AGENT_D_TARGETED_RUST_TESTS=PASS

FRONTEND_TESTS=117 files / 556 passed
TSC=PASS
FRONTEND_BUILD=PASS
CARGO_FMT=PASS
CARGO_CHECK=PASS
...
The active semantic reimport, outdated builtin Recipe, and builtin Recipe
regeneration tests compile against and pass with the connected onboarding API.
The existing sanitized three-item Production Package / explicit rebind /
DEV-078 / fake Comfy coverage remains in `dev059_production_package.rs` and was
not modified by Agent-D.
