...
- Backup v3 was the Pack 07 baseline for `promptEntries` and `promptVersions`; the current v4 format also remaps Shot metadata while continuing to accept v1/v2/v3 archives with empty Shot data where appropriate. Diagnostics do not serialize prompt text.
