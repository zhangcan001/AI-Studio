...
use app_state::{
    AppState, AssetServices, CatalogServices, OrganizationServices, ProductionServices,
    ProjectServices, ShotServices, SystemServices, TaskServices, WorkflowServices,
};
use application::{
    ...
    shot_consistency_binding_service::ShotConsistencyBindingService,
...
fn run_application(logging_status: LoggingStatus) -> Result<(), AppError> {
    ...
    builder
        ...
        .setup(move |app| {
            ...
            let shot_consistency_binding_service = Arc::new(ShotConsistencyBindingService::new(
                shot_consistency_repository.clone(),
                shot_repository.clone(),
                consistency_profile_repository.clone(),
                reference_set_repository.clone(),
            ...
            app.manage(AppState::new(
                ProductionServices {
                    ...
                    package: production_package_service,
                    queue: production_queue_service,
                    admission: production_start_admission_service,
                    audit: production_audit_service,
                    preparation: production_preparation_service,
                    batch_runbook: production_batch_runbook_service,
                    scene: scene_production_service,
                    episode: episode_production_service,
                    series: series_production_service,
                ...
                WorkflowServices {
                    ...
                    recipe_history_query: recipe_history_query_service,
                    onboarding: workflow_onboarding_service,
                    lifecycle: workflow_lifecycle_service,
                    lifecycle_coordinator: workflow_lifecycle_coordinator,
                    benchmark: workflow_benchmark_service,
                },
                AssetServices {
                    query: asset_query_service,
                    library: asset_library_service,
                    data: asset_data_service,
                    usage: asset_usage_service,
                    deletion: asset_deletion_service,
                    video_prompt: asset_video_prompt_service,
                ...
                ShotServices {
                    ...
                    context_resolver: shot_context_resolver,
                    reference_anchor: reference_anchor_service,
                    reference_set: reference_set_service,
                    consistency_profile: consistency_profile_service,
                    consistency_scope_binding: consistency_scope_binding_service,
                    consistency_binding: shot_consistency_binding_service,
                },
                CatalogServices {
                    generation: generation_catalog_service,
                    preset: preset_service,
                    prompt_library: prompt_library_service,
                    model: model_service,
                    tool: tool_service,
                    h3_local_import: h3_local_import_service,
                    batch_workflow_preset: batch_workflow_preset_service,
                },
                TaskServices {
                    query: task_query_service,
                    history: task_history_service,
                    cancellation: task_cancellation_service,
                    recovery: task_recovery_service,
                    provenance_lineage: provenance_lineage_service,
                },
                OrganizationServices {
                    organization: organization_service,
                    project_template: project_template_service,
                    production_structure: production_structure_service,
                },
                SystemServices {
                    data_dirs,
                    comfy: comfy_service,
                    comfy_memory: comfy_memory_service,
        ...
        .on_window_event(|window, event| {
            if let WindowEvent::CloseRequested { api, .. } = event {
                ...
                let diagnostics_service: Option<Arc<DiagnosticsService>> = app_handle
                    .try_state::<AppState>()
                    .map(|state| Arc::clone(&state.system.diagnostics));
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::production_audit::production_audit_snapshot_detail,
            ...
            commands::consistency_bindings::consistency_scope_binding_get,
            commands::consistency_bindings::consistency_scope_binding_replace,
            commands::consistency_bindings::shot_consistency_binding_get,
            commands::consistency_bindings::shot_consistency_binding_replace,
            commands::consistency_bindings::shot_context_draft_get,
