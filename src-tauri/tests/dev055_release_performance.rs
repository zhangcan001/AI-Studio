...
use ai_studio_lib::{
    application::{
        ...
        ports::{
            ...
            ProductionQueueRepository, ProductionStructureRepository, ProjectRecord,
            ProjectRepository, PromptSubmission, ReferenceSetRepository, RepositoryError,
            ShotBatchRepository, ShotBulkRepository, ShotConsistencyRepository, ShotData,
            ShotRecord, ShotRepository, ShotStageConfigRecord, SystemStats, TaskRepository,
            WorkflowLibrarySource, WorkflowLibrarySourceError, WorkflowPackageFiles,
    ...
    domain::{Asset, AssetId, ProfileType, ShotStage, TaskId},
    infrastructure::{
        database::{
