...
Released: `1.1.0` (AI Studio 1.1.0 published; see `docs/DEV_098_RELEASE_1.1.0_PUBLICATION.md`).
Development: `1.2.0` (post-1.1 External Agent → AI Studio Production Handoff train is in progress; manifest remains `1.1.0` until a release candidate).
